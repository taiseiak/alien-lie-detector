...
function SoundManager:init()
    ...
    self.nextSound = nil
    self.sounds = {
        simpleAlien = Ripple.newSound(love.audio.newSource('assets/sounds/simple_alien_loop.wav', 'static'), {
            volume = .2,
            loop = true,
        }),
        alienAbduction = Ripple.newSound(love.audio.newSource('assets/sounds/alien_abduction.wav', 'static'), {
            volume = .2,
            loop = true,
        }),
        selectionSound = Ripple.newSound(love.audio.newSource('assets/sounds/TN 26.wav', 'static'), {
            volume = .2,
            loop = false,
        })
    }
